...
class WideDeep3DRepresentationNet(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.conv5 = nn.Conv3d(64, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn5 = nn.BatchNorm3d(64)
        self.pool3 = nn.MaxPool3d(kernel_size=(1, 3, 3), stride=(1, 2, 2), padding=(0, 1, 1))

        self.conv6 = nn.Conv3d(64, 128, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn6 = nn.BatchNorm3d(128)
        self.conv7 = nn.Conv3d(128, 128, kernel_size=3, stride=1, padding=1, bias=False)
