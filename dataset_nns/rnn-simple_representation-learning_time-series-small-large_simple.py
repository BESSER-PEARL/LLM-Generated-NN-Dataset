...
class TimeSeriesRNNRepresentation(nn.Module):
    def __init__(self):
        super(TimeSeriesRNNRepresentation, self).__init__()
        self.rnn = nn.RNN(input_size=2048, hidden_size=128, num_layers=2, nonlinearity='tanh', batch_first=True, dropout=0.0, bidirectional=False)
