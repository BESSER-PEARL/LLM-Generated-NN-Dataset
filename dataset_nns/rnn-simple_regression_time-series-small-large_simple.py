...
class RnnSimpleRegression(nn.Module):
    def __init__(self):
        super().__init__()
        self.rnn = nn.RNN(input_size=2048, hidden_size=128, num_layers=2, nonlinearity='tanh', batch_first=True, bias=True, dropout=0.0, bidirectional=False)
