...
class SmallImageCNNRegressor(nn.Module):
    def __init__(self):
        super(SmallImageCNNRegressor, self).__init__()
        ...
        self.conv5 = nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn3 = nn.BatchNorm2d(128)
        self.relu5 = nn.ReLU(inplace=True)
        self.conv6 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1, bias=True)
