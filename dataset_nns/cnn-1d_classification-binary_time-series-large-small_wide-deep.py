...
class CNN1DClassifier(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv1d(32, 128, kernel_size=7, stride=2, padding=3)
        ...
        self.conv5 = nn.Conv1d(320, 384, kernel_size=3, stride=2, padding=1)
        self.bn5 = nn.BatchNorm1d(384)
        self.conv6 = nn.Conv1d(384, 512, kernel_size=3, stride=2, padding=1)
